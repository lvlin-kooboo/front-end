var loader = {
	...
	$$: function(t) {
		return "#" == t.charAt(0) ? document.getElementById(t.slice(1)) : "." == t.charAt(0) ? document.querySelectorAll(t) : document.getElementsByTagName(t)
	},
	resize: function() {
		if (this.isShow) {
			var t = this.loaded / this.total;
			t > 1 && (t = 1);
			var c = this,
				i = (window.innerWidth, 165),
				o = 130;
			this.loadW = i, this.loadH = o;
			var l = (.5 * (window.innerHeight - o), c.$$("#" + c.loadTopId));
			l.style.clip = "clip:rect(" + (o - o * t) + "px," + i + "px," + o + "px,0)", l.style.webkitTransition = "all 0ms linear", l.style.transition = "all 0ms linear", setTimeout(function() {
				l.style.webkitTransition = "all 300ms linear", l.style.transition = "all 300ms linear"
			}, 100)
		}
	},
	hide: function() {
		this.isShow = !1, this.cbfun && this.cbfun();
		var t = this,
			c = t.$$("#" + this.loadId);
		c.style.webkitTransition = "all 300ms linear", 
		c.style.transition = "all 300ms linear", 
		c.style.opacity = "0", 
		setTimeout(function() {
			c.style.display = "none", document.body.removeChild(c)
		}, 300)
	},
	init: function() {
		...
		t.id = this.loadId, 
		t.style.cssText = "position:absolute;z-index:9999;left:0;top:0;width:100%;height:100%;background:" + this.backColor + ";overflow:hidden;margin:0;padding:0;", t.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" id="' + this.loadBgId + '" style="position:absolute;width:165px;height:130px;left:50%;top:50%;margin-left:-82px;margin-top:-75px;"><g><path fill="#aaaaaa" d="' + this.svgPath + '" /></g></svg><svg xmlns="http://www.w3.org/2000/svg" id="' + this.loadTopId + '" style="position:absolute;width:165px;height:0;left:50%;top:50%;margin-left:-82px;margin-top:-75px;"><g><path fill="' + this.color + '" d="' + this.svgPath + '" /></g></svg>', document.body.appendChild(t)
	},
	show: function(t, c, i) {
		var o = this;
		i && (this.backColor = i), 
		o.$$("#" + o.loadId).style.backgroundColor = this.backColor, 
		this.isShow = !0, 
		this.cbfun = t;
		var o = this;
		this.imgData = {}, 
		this.total = c.length, 
		this.loaded = 0;
		for (var l = 0; l < this.total; l++) this.loadImage(c[l]);
		o.resize(), window.onresize = function() {
			o.resize()
		}
	},
	...
	checkLoadComplete: function() {
		var t = this;
		if (t.loaded == t.total) t.hide();
		else {
			var c = t.loaded / t.total;
			c > 1 && (c = 1), t.$$("#" + t.loadTopId).style.height = "130px", t.$$("#" + t.loadTopId).style.clip = "rect(" + (t.loadH - t.loadH * c) + "px," + t.loadW + "px," + t.loadH + "px,0)"
		}
	}
};
loader.init();